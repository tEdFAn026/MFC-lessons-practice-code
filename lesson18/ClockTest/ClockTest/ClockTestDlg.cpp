...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_CLOCKCTRL1, m_cl);
}
...
BEGIN_EVENTSINK_MAP(CClockTestDlg, CDialogEx)
	ON_EVENT(CClockTestDlg, IDC_CLOCKCTRL1, DISPID_CLICK, CClockTestDlg::ClickClockctrl1, VTS_NONE)
END_EVENTSINK_MAP()


void CClockTestDlg::ClickClockctrl1()
{
	// TODO: Add your message handler code here
	if(!m_Ncl)
		m_Ncl.Create(L"cc", WS_CHILD | WS_VISIBLE, CRect(0, 0, 100, 100), this, 123);
	m_Ncl.Hello();
}
